...
// Integration Setting All Route
Route::controller(SettingController::class)->group(function(){
    Route::get('/integration/setting','IntegrationSetting')->name('integration.setting');
    Route::post('/update/integration','IntegrationUpdate')->name('update.integration');
});
