...
if (!@json((bool) $stripePublishableKey)) {
  document.getElementById('card-errors').textContent = 'Stripe payment is not configured yet.';
  var submitBtn = document.querySelector('#payment-form button[type=\"submit\"]');
  if (submitBtn) {
