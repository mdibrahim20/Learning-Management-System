...
@section('title')
{{ $subcategory->subcategory_name }} | Nuvetic
@endsection

<div class="front-shell">
    <section class="page-hero">
        <span class="kicker">Subcategory</span>
        <h1>{{ $subcategory->subcategory_name }}</h1>
        <p style="color:var(--muted);margin:0">{{ count($courses) }} courses available.</p>
    </section>

    <section class="front-section" style="margin-top:14px;">
        <div class="section-head">
            <div>
                <h2>Courses in {{ $subcategory->subcategory_name }}</h2>
                <p>Focused lessons with real outcomes.</p>
            </div>
        </div>
